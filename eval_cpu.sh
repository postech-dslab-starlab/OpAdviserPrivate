#!/bin/bash
# =============================================================================
# CPU Prediction Accuracy Evaluation Script
# =============================================================================
# Evaluates CPU usage prediction accuracy using trained models.
#
# Usage (via Docker):
#   docker compose up -d
#   docker exec -it OpAdviser.sh -c "sh /root/OpAdviser/eval_cpu.sh"
#
# Or manually inside the container:
#   sh /root/OpAdviser/eval_cpu.sh
# =============================================================================
